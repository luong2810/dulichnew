...
@section('content')
	...
	<h2 class="page-header" style="color: inherit;font-size: xx-large;">Nhóm đề cử  </h2>
  ...
  <h2 class="page-header" style="color: inherit;font-size: xx-large;">Kinh nghiệm thành viên </h2>
  ...
  <div class="row">
    ...
    <h2 class="page-header" style="color: inherit;font-size: xx-large;">Dịch vụ đề cử </h2>
